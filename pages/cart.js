...
const Cart = () => {
  ...
  const handlePayment = async () => {
    ...
    if(newCart.length < cart.length){
      ...
      return dispatch({ type: 'NOTIFY', payload: {error: 'The product is out of stock or quantity is insufficient.'}})
    }
  ...
  if (cart.length === 0) return <img className="img-responsive w-100" src="/empty shopping cart.png" alt="not empty"/>
    return (
